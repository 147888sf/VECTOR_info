> Информация в этом репозитории защищена лицензией All Rights Reserved (Все Права Защищены), и я, как автор запрещаю его использование или редактирование под другие проекты кроме VECTOR.
